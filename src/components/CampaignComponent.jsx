...
import { getPredefinedKeywords, addCampaign, getCampaign, updateCampaign, getUserBalance } from "../services/CampaignService";
...
const CampaignComponent = () => {
    ...
    useEffect(() => {
        ...
        getUserBalance(userId).then(response => setEmeraldBalance(response.data))
    ...
    function saveOrUpdateCampaign(e) {
        ...
        if (validateForm()) {
            ...
            if (campaignFund > emeraldBalance) {
                alert("Not enough funds in your Emerald account.");
                return;
            }
            ...
            if(id) {
                ...
                addCampaign(userId, campaign).then(response => {
                    console.log(response);
                    setEmeraldBalance(prev => prev - campaignFund);
                    navigator('/campaigns');
                }).catch(error => {
                    console.error(error);
                });
            ...
            <div className="container">
                ...
                <div className="row">
                    <div className="card col-md-6 offset-md-3 offset-md-3">
                        {pageTitle()}
                        <div className="mb-3">
                            <h5 className="text-center">Your Emerald Balance: {emeraldBalance} zł</h5>
                        </div>
